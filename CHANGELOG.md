...
- Added keybinds to open charm, tome and aspect guide
...
- Added buttons in configurable list for overlay position, size and alignment. They will open the overlay management screen on click

Settings Screen
- Added buttons in overlays configurable list for overlay position, size and alignment. They will open the overlay management screen on click
...
- Screen will display options to update and connect to server, update and restart, ignore update for now, ignore update permenantly, view changelog and return to title screen
