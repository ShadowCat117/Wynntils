...
public class GuideCharmItemStackButton extends WynntilsButton {
    ...
    public GuideCharmItemStackButton(
            int x, int y, int width, int height, GuideCharmItemStack itemStack, WynntilsCharmGuideScreen screen) {
        super(x, y, width, height, Component.literal("Guide CharmItemStack Button"));
    ...
    public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
        CustomColor color =
                CustomColor.fromChatFormatting(itemStack.getCharmInfo().tier().getChatFormatting());
