...
public record KeyBindDefinition(
    ...
    public static final KeyBindDefinition SHARE_ITEM = register(
            "shareItem", Managers.KeyBind.CHAT_CATEGORY, InputConstants.Type.KEYSYM, InputConstants.KEY_F5, true);
    ...
    public static final KeyBindDefinition RIDE_MOUNT = register(
            "mountHorse", Managers.KeyBind.COMBAT_CATEGORY, InputConstants.Type.KEYSYM, InputConstants.KEY_R, true);

    public static final KeyBindDefinition CAST_FIRST_SPELL = register(
            "castFirstSpell", Managers.KeyBind.COMBAT_CATEGORY, InputConstants.Type.KEYSYM, InputConstants.KEY_Z, true);
    ...
    public static final KeyBindDefinition CAST_THIRD_SPELL = register(
            "castThirdSpell", Managers.KeyBind.COMBAT_CATEGORY, InputConstants.Type.KEYSYM, InputConstants.KEY_C, true);
    ...
    public static final KeyBindDefinition LOCK_SLOT = register(
            "lockSlot", Managers.KeyBind.INVENTORY_CATEGORY, InputConstants.Type.KEYSYM, InputConstants.KEY_H, true);
    ...
    public static final KeyBindDefinition OPEN_GUILD_MAP = register(
            "openGuildMap", Managers.KeyBind.MAP_CATEGORY, InputConstants.Type.KEYSYM, InputConstants.KEY_J, true);

    public static final KeyBindDefinition OPEN_MAIN_MAP = register(
            "openMainMap", Managers.KeyBind.MAP_CATEGORY, InputConstants.Type.KEYSYM, InputConstants.KEY_M, true);

    public static final KeyBindDefinition NEW_WAYPOINT = register(
            "newWaypoint", Managers.KeyBind.MAP_CATEGORY, InputConstants.Type.KEYSYM, InputConstants.KEY_B, true);
    ...
    public static final KeyBindDefinition OPEN_TERRITORY_MENU = register(
            "openTerritoryMenu", Managers.KeyBind.UI_CATEGORY, InputConstants.Type.KEYSYM, InputConstants.KEY_U, true);

    public static final KeyBindDefinition OPEN_CONTENT_BOOK = register(
            "openContentBook", Managers.KeyBind.UI_CATEGORY, InputConstants.Type.KEYSYM, InputConstants.KEY_K, true);

    public static final KeyBindDefinition OPEN_WYNNTILS_MENU = register(
            "openWynntilsMenu", Managers.KeyBind.UI_CATEGORY, InputConstants.Type.KEYSYM, InputConstants.KEY_I, true);
    ...
    public static final KeyBindDefinition TOGGLE_GAMMABRIGHT = register(
            "gammabright", Managers.KeyBind.UTILITIES_CATEGORY, InputConstants.Type.KEYSYM, InputConstants.KEY_G, true);
